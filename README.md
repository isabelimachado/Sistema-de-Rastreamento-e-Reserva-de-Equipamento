<h2>Sistema de Reserva e Rastreamento de Equipamento</h2>
...
<ul><li>Identificar quem está utilizando cada equipamento</li></ul>
<ul><li>Por quanto tempo ele está reservado</li></ul>
<ul><li>Facilitar a busca através de filtros de pequisa</li></ul>
